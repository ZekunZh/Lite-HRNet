...
channel_cfg = dict(
    num_output_channels=130,
    dataset_joints=130,
    dataset_channel=[
       list(range(130))
    ],
    inference_channel=list(range(130)))
...
data = dict(
    ...
    train=dict(
        ...
        task='6incidences',
        ann_file=f'{data_root}/annotations/2022-05-23T16h54m10s_6incidences_train_v3_coco.json',
    ...
    val=dict(
        type='TopDownGleamerDataset',
        task='6incidences',
        ann_file=f'{data_root}/annotations/2022-05-23T16h55m42s_6incidences_test_v3_coco.json',
