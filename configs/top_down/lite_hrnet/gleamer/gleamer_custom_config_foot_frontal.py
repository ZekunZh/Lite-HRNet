...
data = dict(
    ...
    train=dict(
        ...
        ann_file=f'{data_root}/annotations/2022-03-29T09h23m01s_frontal_foot_train_coco.json',
        img_prefix=f'{data_root}/train/',
        data_cfg=data_cfg,
        pipeline=train_pipeline),
    val=dict(
        type='TopDownGleamerDataset',
        ann_file=f'{data_root}/annotations/2022-03-29T09h23m00s_frontal_foot_test_coco.json',
